...
public class low extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        low = inflater.inflate(R.layout.low, container, false);
        return low;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        taskdata = low.findViewById(R.id.taskdata);
        datePicker = low.findViewById(R.id.date);
        timePicker = low.findViewById(R.id.time);
        recyclerView = low.findViewById(R.id.recycleview);
    ...
    public class deletedata extends AsyncTask<UserModel, Void,List<UserModel>>{
        ...
        protected List<UserModel> doInBackground(UserModel... userModels) {
            ...
            return appdatabase.userDao().getLow();
        }
